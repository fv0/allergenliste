<div class="modal fade" id="modalImpressum" tabindex="-1" role="dialog" aria-labelledby="labelImpressum">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <h4 class="modal-title" id="labelImpressum">Impressum</h4>
      </div>
      <div class="modal-body">
        ...
        <h4 id="haftungfürinhalte">Haftung für Inhalte</h4>
        ...
        <h4 id="haftungfürlinks">Haftung für Links</h4>
