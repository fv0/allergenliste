<div class="modal fade" id="modalDatenschutz" tabindex="-1" role="dialog" aria-labelledby="labelDatenschutz">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <h4 class="modal-title" id="labelDatenschutz">Datenschutz</h4>
      </div>
      <div class="modal-body">
        ...
        <h4 id="datenschutzerklärungfürdienutzungvongoogleanalytics">Datenschutzerklärung für die Nutzung von Google Analytics</h4>
